...
* Template Name: Page - Profile - Assistant
        ...
        <div id="primary" class="content-area col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
            ...
            <main id="main" class="site-main" role="main">
                ...
                <!-- <?php //while ( have_posts() ) : the_post(); ?> --><!-- i don't know why we had this loop within a loop -->
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class( 'assistants_loop' ); ?>>
                        <div class="entry-content">
                        <?php 

                            $assistants_query = new WP_Query( 'category_name=profile-assistant');

                            if ( $assistants_query->have_posts() ) : while ( $assistants_query->have_posts() ) : $assistants_query->the_post(); ?>
                                <div class="row">
